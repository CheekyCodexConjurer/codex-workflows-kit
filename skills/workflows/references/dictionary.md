...
- `preflight-subA`: read-only scouts and claim-mapped OpenCode workers may start before/during implementation when `subA-speed`; independent reviewers remain gated by `integrated-freeze`.
